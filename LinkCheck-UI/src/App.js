...
function App() {
  ...
  const [loadingPageAnalysisResults, setLoadingPageAnalysisResults] = useState(false);
    ...
    <div className="App">
      ...
      <div style={{ padding: 20, backgroundColor: '#1f2a47' }}>
        <input
          ...
          style={{ width: '500px', height: '30px', fontSize: '24px', padding: '5px', borderRadius: '15px', marginRight: '5px' }}
